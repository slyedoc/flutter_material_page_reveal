...
class AnimatedPageDragger {
  static const PERCENT_PER_MILLSECOND = 0.005;
  ...
  AnimatedPageDragger({
    ...
    final startingSlidePercent = slidePercent;
    var endSlidePercent;
    var duration;
    ...
    if(transitionGoal == TransitionGoal.open) {
      ...
      duration = Duration(
        milliseconds:  (slideRemaining / PERCENT_PER_MILLSECOND).round()
      );
    } else {
      endSlidePercent = 0.0;
      duration = Duration(
        milliseconds: (slidePercent / PERCENT_PER_MILLSECOND).round()
      );
    }
...
class SlideUpdate {
  ...
  SlideUpdate(this.updateType, this.direciton, this.slidePercent);
}
